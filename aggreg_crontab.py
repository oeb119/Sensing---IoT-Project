...
API_key = "657774aa7ed3e7339996d80c"
...
# ONEMORE API 65759e2e32ec89d21b701281 MAC 0 left
# CARPET API 657774f07ed3e7339996d80e RPI
...
# BOOK API 657774aa7ed3e7339996d80c MAC
...
for day in range(20,28):        
    ...
    if day != 27:
        ...
        # update_api(fl_channel, day_to_field(day), cheapest_flight_result[4])
        # print(fl_channel + str(day_to_field(day)) + '=' + str(cheapest_flight_result[4]))
